...
- File method: `public/google30302848f8b35cc7.html` served at `/google30302848f8b35cc7.html`.
- Static `public/sitemap.xml` (Home, About, Plaques, Events, Contact) + `public/robots.txt` Sitemap → `https://thehomelesstwenty1904.org/sitemap.xml`.
